...
export default function KocaeliScreen() {
            ...
            <div className="subProjects">
                <div className="headerStage">
                    <div className="content">
                        <div className="left">KOCAELİ, TÜRKİYE</div>
                        <div className="right">
                            <div className="firstLink"><Link to="/">ANASAYFA</Link></div>&nbsp;/&nbsp;<div className="firstLink"><Link to="/projects">PROJELER</Link></div>&nbsp;/&nbsp;<div className="secondLink">KOCAELİ, TÜRKİYE</div>
                        </div>
                    </div>
                </div>
