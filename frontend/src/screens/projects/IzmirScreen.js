...
export default function IzmirScreen() {
            ...
            <div className="subProjects">
                <div className="headerStage">
                    <div className="content">
                        <div className="left">İZMİR, TÜRKİYE</div>
                        <div className="right">
                            <div className="firstLink"><Link to="/">ANASAYFA</Link></div>&nbsp;/&nbsp;<div className="firstLink"><Link to="/projects">PROJELER</Link></div>&nbsp;/&nbsp;<div className="secondLink">İZMİR, TÜRKİYE</div>
                        </div>
                    </div>
                </div>
