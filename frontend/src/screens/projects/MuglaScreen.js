...
export default function MuglaScreen() {
            ...
            <div className="subProjects">
                <div className="headerStage">
                    <div className="content">
                        <div className="left">MUĞLA, TÜRKİYE</div>
                        <div className="right">
                            <div className="firstLink"><Link to="/">ANASAYFA</Link></div>&nbsp;/&nbsp;<div className="firstLink"><Link to="/projects">PROJELER</Link></div>&nbsp;/&nbsp;<div className="secondLink">MUĞLA, TÜRKİYE</div>
                        </div>
                    </div>
                </div>
