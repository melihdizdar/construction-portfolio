...
export default function IstanbulScreen() {
            ...
            <div className="subProjects">
                <div className="headerStage">
                    <div className="content">
                        <div className="left">İSTANBUL, TÜRKİYE</div>
                        <div className="right">
                            <div className="firstLink"><Link to="/">ANASAYFA</Link></div>&nbsp;/&nbsp;<div className="firstLink"><Link to="/projects">PROJELER</Link></div>&nbsp;/&nbsp;<div className="secondLink">İSTANBUL, TÜRKİYE</div>
                        </div>
                    </div>
                </div>
                <div className="descriptionSplitStage">
                    ...
                    <div className="right">
                        ...
                        <div className="content">
                            ...
                            <div className="subText">Tamamlandı</div>
                        </div>
                        <div className="content">
