            ...
            <div className="subServices">
                <div className="headerStage">
                    <div className="content">
                        <div className="left">MİMARİ BİNA YAPIMI</div>
                        <div className="right">
                            <div className="firstLink"><Link to="/">ANASAYFA</Link></div>&nbsp;/&nbsp;<div className="firstLink"><Link to="/services">SERVİSLER</Link></div>&nbsp;/&nbsp;<div className="secondLink">MİMARİ BİNA YAPIMI</div>
                        </div>
                    </div>
                </div>
                <div className="contentStage">
                    ...
                    <div className="right">
                        <div className="mainHeader">MİMARİ BİNA YAPIMI</div>
                        ...
                        <div className="subServicesCarousel">
                            <Carousel
                                ...
                                <div>
                                    <img src="https://images.pexels.com/photos/2489/street-subServices-construction-industry.jpg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="slider_1"/>
                                </div>
                                <div>
