            ...
            <div className="planning">
                <div className="headerStage">
                    <div className="content">
                        ...
                        <div className="right">
                            <div className="firstLink"><Link to="/">ANASAYFA</Link></div>&nbsp;/&nbsp;<div className="firstLink"><Link to="/services">SERVİSLER</Link></div>&nbsp;/&nbsp;<div className="secondLink">ÖN İNŞAAT PLANLAMA</div>
                        </div>
                    </div>
                </div>
                <div className="contentStage">
                    ...
                    <div className="right">
                        <div className="mainHeader">ÖN İNŞAAT PLANLAMA</div>
