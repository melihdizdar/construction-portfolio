...
export default function InteriorScreen() {
    ...
    return (
        <InteriorScreenStyled>
            <div className="interior">
                <div className="headerStage">
                    <div className="content">
                        <div className="left">İÇ MEKAN TASARIM</div>
                        <div className="right">
                            <div className="firstLink"><Link to="/">ANASAYFA</Link></div>&nbsp;/&nbsp;<div className="firstLink"><Link to="/services">SERVİSLER</Link></div>&nbsp;/&nbsp;<div className="secondLink">İÇ MEKAN TASARIM</div>
                        </div>
                    </div>
                </div>
                <div className="contentStage">
                    ...
                    <div className="right">
                        <div className="mainHeader">İÇ MEKAN TASARIM</div>
                        ...
                        <div className="interiorCarousel">
                            <Carousel
                                showArrows={true}
                                infiniteLoop={true}
                                showThumbs={false}
...
const InteriorScreenStyled = styled.div`
