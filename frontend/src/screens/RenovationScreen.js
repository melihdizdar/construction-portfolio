...
export default function RenovationScreen() {
    ...
    return (
        <RenovationScreenStyled>
            <div className="renovation">
                <div className="headerStage">
                    <div className="content">
                        <div className="left">EV YENİLEME</div>
                        <div className="right">
                            <div className="firstLink"><Link to="/">ANASAYFA</Link></div>&nbsp;/&nbsp;<div className="firstLink"><Link to="/services">SERVİSLER</Link></div>&nbsp;/&nbsp;<div className="secondLink">EV YENİLEME</div>
                        </div>
                    </div>
                </div>
                <div className="contentStage">
                    ...
                    <div className="right">
                        <div className="mainHeader">EV YENİLEME</div>
...
const RenovationScreenStyled = styled.div`
